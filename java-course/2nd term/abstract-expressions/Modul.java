...
public class Modul extends BinaryOperations implements Functions {
	public Modul(Functions left, Functions right) {
		super(left, right);
		pr = Prior.HIGH;
	}
	...
	protected Functions mathReduction(Functions l, Functions r) {
		...
		return checkRules(r, new int[]{ 1 }, new Functions[]{ new Const(0) });
	}
}
